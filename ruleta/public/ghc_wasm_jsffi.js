...
ZC0ZCruletazm0zi1zi0zi0zminplacezmappZCRuletaZC: ($1) => {let v = new Audio($1); if (v) { if (window.currentVoice) { window.currentVoice.pause(); } window.currentVoice = v; v.volume = 1.0; let ctx = window.audioCtx; let gainNode = window.gainNode; try { if (!ctx) { ctx = new (window.AudioContext || window.webkitAudioContext)(); gainNode = ctx.createGain(); gainNode.gain.value = 4.5; gainNode.connect(ctx.destination); window.audioCtx = ctx; window.gainNode = gainNode; } if (ctx.state === 'suspended') { ctx.resume(); } let src = ctx.createMediaElementSource(v); src.connect(gainNode); } catch (e) {} v.play().catch(e => {}); }},
ZC1ZCruletazm0zi1zi0zi0zminplacezmappZCRuletaZC: () => {if (typeof confetti === 'function') { confetti({ particleCount: 150, spread: 80, origin: { y: 0.6 }, zIndex: 99999 }); }},
ZC2ZCruletazm0zi1zi0zi0zminplacezmappZCRuletaZC: ($1,$2) => {let a = document.getElementById($2); if (a) { a.volume = 0.30; if ($1) { a.play().catch(e => {}); } else { a.pause(); } }},
ZC3ZCruletazm0zi1zi0zi0zminplacezmappZCRuletaZC: ($1,$2) => {let a = document.getElementById($1); if (a) { a.volume = $2; a.currentTime = 0; a.play().catch(e => {}); }},
ZC0ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziJSONZC: ($1) => {return globalThis.miso.typeOf($1);},
ZC2ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziJSONZC: ($1) => {return JSON.stringify($1);},
ZC2ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: ($1) => {return $1.length},
ZC5ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: ($1) => {return requestAnimationFrame($1);},
ZC6ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: ($1,$2) => {return $2[$1]},
ZC7ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: ($1) => {return $1},
ZC8ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: ($1) => {return $1},
ZC9ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: ($1) => {return $1},
ZC11ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: ($1,$2) => {return $2[$1]},
ZC12ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: () => {return {}},
ZC14ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: ($1,$2,$3) => ($3[$1]=$2),
ZC16ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: ($1,$2,$3) => {return $1.apply($2, $3);},
ZC17ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: ($1) => {return Object.keys($1);},
ZC23ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: ($1) => ((...args) => __exports.ghczuwasmzujsffiZC22ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC($1, ...args)),
ZC31ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: ($1) => ((...args) => __exports.ghczuwasmzujsffiZC30ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC($1, ...args)),
ZC37ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: ($1) => ((...args) => __exports.ghczuwasmzujsffiZC36ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC($1, ...args)),
ZC39ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: ($1) => ((...args) => __exports.ghczuwasmzujsffiZC38ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC($1, ...args)),
ZC42ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: () => {return globalThis},
ZC43ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: () => {return null;},
ZC51ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: ($1,$2) => ($1.push($2)),
ZC52ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: () => {return [];},
ZC53ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: ($1) => {return $1},
ZC54ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: ($1) => {return $1},
ZC55ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziDSLziFFIZC: ($1) => {if ($1 === 0.0) return false;
return true;},
ZC0ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCMisoziRuntimeZC: () => {// ts/miso/util.ts
var version = "1.9.0.0";
...
ZC1ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCDataziJSStringZC: ($1) => {return ($1).toString()},
ZC2ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCDataziJSStringZC: ($1) => {return ($1).toString()},
ZC3ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCDataziJSStringZC: () => {return ''},
ZC4ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCDataziJSStringZC: ($1,$2) => {return $1 + $2},
ZC5ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCDataziJSStringZC: ($1,$2) => {return $1 === $2},
ZC6ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCDataziJSStringZC: ($1,$2) => {if ($1 < 1) { return ''; }
...
ZC7ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCDataziJSStringZC: ($1,$2) => {if ($1 === $2) return 0;
else if ($1 > $2) return 1;
else return -1;},
ZC41ZCmisozm1zi10zi0zi0zm8ed5e837e64bf06a509e3e7624dac22fffc8c0727d6326d197e67fba02d39f73ZCDataziJSStringZC: ($1,$2) => {return $1 + String.fromCharCode($2);},
